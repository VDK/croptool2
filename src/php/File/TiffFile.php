...
class TiffFile extends File implements FileInterface
{
    ...
    /** @var int[]|null Cached scene indexes of the real pages, or null when not parsed yet. */
    protected $ifdInfo;
     ...
     *
     * @return int[]|null Scene indexes of the real pages, or null when the
     ...
     * both byte orders.
     *
     * Returns the scene indexes of the real pages. Embedded reduced-resolution
     * subfiles (scanner previews/thumbnails, NewSubfileType bit 0) are skipped.
     *
     * @return int[]
     */
